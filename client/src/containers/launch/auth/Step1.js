...
class SignUp extends Component {
    ...
    render() {
        const { handleSubmit, fields: { name,   email, password, passwordConfirm },pristine} = this.props;
        console.log(localStorage.getItem('signup_step'));
        return (
...
//{localStorage.getItem('signup_step')===2? <button className = "btn btn-primary">Next</button> : null }
